...
#ifndef FUJICOIN_TEST_SCRIPTNUM10_H
#define FUJICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fujicoin Core 0.10.0, for cross-comparison.
 */
public:
