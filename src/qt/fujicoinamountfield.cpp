...
public:
    ...
    void fixup(QString &input) const
    {
        ...
        if(valid)
        {
            input = FujicoinUnits::format(currentUnit, val, false, FujicoinUnits::separatorAlways);
    ...
    {
        lineEdit()->setText(FujicoinUnits::format(currentUnit, value, false, FujicoinUnits::separatorAlways));
        Q_EMIT valueChanged();
    }
    ...
    void stepBy(int steps)
    {
        ...
        val = qMin(qMax(val, CAmount(0)), FujicoinUnits::maxMoney());
        setValue(val);
    }
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = fm.width(FujicoinUnits::format(FujicoinUnits::BTC, FujicoinUnits::maxMoney(), false, FujicoinUnits::separatorAlways));
...
#include "fujicoinamountfield.moc"
