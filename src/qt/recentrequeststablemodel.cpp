    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return FujicoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, FujicoinUnits::separatorNever);
            else
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+FujicoinUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
