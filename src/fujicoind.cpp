 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Fujicoin (http://www.fujicoin.org/),
    ...
    try
    {
        ...
        for (int i = 1; i < argc; i++) {
            if (!IsSwitchChar(argv[i][0])) {
                fprintf(stderr, "Error: Command line contains unexpected token '%s', see fujicoind -h for a list of options.\n", argv[i]);
                exit(EXIT_FAILURE);
            }
        }
