...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), FUJICOIN_PID_FILENAME));
#endif
...
/** Sanity checks
 *  Ensure that Fujicoin is running in a usable environment with all
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", FUJICOIN_CONF_FILENAME)).string());
