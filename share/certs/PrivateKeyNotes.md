...
unlocked to sign the Fujicoin-Qt.app bundle.
...
allowing somebody to distribute a Fujicoin-Qt.app or fujicoin-qt-setup.exe with a valid
...
that the fujicoin-qt.exe file inside the installer had not been tampered with.
