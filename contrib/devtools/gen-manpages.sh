...
FUJICOIND=${FUJICOIND:-$SRCDIR/fujicoind}
FUJICOINCLI=${FUJICOINCLI:-$SRCDIR/fujicoin-cli}
FUJICOINTX=${FUJICOINTX:-$SRCDIR/fujicoin-tx}
FUJICOINQT=${FUJICOINQT:-$SRCDIR/qt/fujicoin-qt}
