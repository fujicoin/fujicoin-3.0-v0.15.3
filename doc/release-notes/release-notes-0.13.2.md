Fujicoin Core version 0.13.2 is now available from:

  <https://fujicoin.org/bin/fujicoin-core-0.13.2/>
...
- #8908 `4a974b2` Update fujicoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow fujicoin-tx to create v2 transactions (btcdrak)
