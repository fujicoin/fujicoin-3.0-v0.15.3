Fujicoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/fujicoin/files/Fujicoin/fujicoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Fujicoin
...
New/changed settings (command-line or fujicoin.conf file)
--------------------------------------------------------
