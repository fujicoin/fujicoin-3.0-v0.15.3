Fujicoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/fujicoin/files/Fujicoin/fujicoin-0.5.4/
...
http://gitorious.org/fujicoin/fujicoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Fujicoin-Qt notifications under Growl 1.3.
Increase required age of Fujicoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFujicoin properly when installing Fujicoin-Qt over it. (Windows)
