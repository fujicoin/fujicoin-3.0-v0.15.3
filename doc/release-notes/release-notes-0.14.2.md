Fujicoin Core version 0.14.2 is now available from:

  <https://fujicoin.org/bin/fujicoin-core-0.14.2/>
...
(in Fujicoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Fujicoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate fujicoin-config.h as necessary (theuni)
