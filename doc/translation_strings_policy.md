...
This document provides guidelines for internationalization of the Fujicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fujicoin_en.ts` remains unchanged.
